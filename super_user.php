...
<br>
                ...
                <div class="container text-center">
            <h6 class="section-title mb-5">Other Users</h6>
            <!-- contact form -->
<table>
<tr style="text-align: left;
  padding: 8px;">
...
<td><?php echo($row["phone_Number"]); ?></td>
<td><?php echo($row["UserType"]); ?></td>
<td><button class="btn btn-primary py-3 px-5" onclick="return confirm('Are you sure that you want to delete this user?')?window.location.href='functions/main.php?action=deleteU&id=<?php echo($row["userId"]); ?>':true;" title='Delete User'>Delete</button></td>
</tr>
<?php
}
} else { echo "No results"; }
...
<td><img style="width: 50px" src="img/<?php echo($row["article_display"]); ?>" title="<?php echo($row["article_title"]); ?>"></td>
...
<br> 
        ...
        <div class="container text-center">
            ...
            <!-- contact form -->
                ...
                <div class="container text-center">
            <h6 class="section-title mb-5">Register A User</h6>
            <!-- contact form -->
                                <form action="functions/main.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input name="fname" type="text" class="form-control" placeholder="Fullname" required>
                                        <input type="hidden" value="Administrator" name="type" required>
                                    </div>
                                    <div class="form-group">
                            ...
                            <select class="form-control" name="gender" required>
                              ...
                              <option value="Female">Female</option>
                                    ...
                                    <div class="form-group text-right">
                                        <input type="submit" name="regu" style="width: 100%;" class="btn btn-primary" value="Register">
                                        <br>
                                        <br>
                                        <br>
                                    </div>
