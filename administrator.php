...
<br>
                ...
                <div class="container text-center">
            <h6 class="section-title mb-5">Authors</h6>
            <!-- contact form -->
 <table>
<tr style="text-align: left;
  padding: 8px;">
...
<td><?php echo($row["Address"]); ?></td>
<td><?php echo($row["UserType"]); ?></td>
<td><button class="btn btn-primary py-3 px-5" onclick="return confirm('Are you sure that you want to delete this author?')?window.location.href='functions/main.php?action=deleteU&id=<?php echo($row["userId"]); ?>':true;" title='Delete Author'>Delete</button></td>
</tr>
<?php
}
} else { echo "No results"; }
...
<br> 
        ...
        <div class="container text-center">
            ...
            <!-- contact form -->
                ...
                <div class="container text-center">
            <h6 class="section-title mb-5">Register An Author</h6>
            <!-- contact form -->
<form action="functions/main.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                            ...
                            <select class="form-control" name="gender" required>
                              ...
                              <option value="Female">Female</option>
                                    ...
                                    <div class="form-group text-right">
                                        <input type="submit" style="width: 100%;" name="regu" class="btn btn-primary" value="Register">
                                        <br>
                                        <br>
                                        <br>
                                    </div>
